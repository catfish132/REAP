...
def build_optimizer(params, opt):
    model_parameters = filter(lambda parameter: parameter.requires_grad, params)
    if opt.optim == 'rmsprop':
        return optim.RMSprop(model_parameters, opt.lr, opt.optim_alpha, opt.optim_epsilon, weight_decay=opt.weight_decay)
        ...
        return optim.AdamW(params, opt.lr, (opt.optim_alpha, opt.optim_beta), opt.optim_epsilon, weight_decay=opt.weight_decay)
    else:
