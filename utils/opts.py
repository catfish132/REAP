...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='/home/jinyuda/dataset/luoruotian_data/cocotalk.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='/home/jinyuda/dataset/luoruotian_data/cocotalk_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/home/jinyuda/dataset/luoruotian_data/cocotalk_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='data/cocotalk_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='/home/jinyuda/dataset/luoruotian_data/cocotalk_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--data_in_memory', action='store_true',default=False,
...
def add_eval_options(parser):
    ...
    parser.add_argument('--input_json', type=str, default='', 
                    help='path to the json file containing additional info and vocab. empty = fetch from model checkpoint.')#词表+caption
